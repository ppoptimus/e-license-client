    ...
    <div className="col-xl-12">
        <div className="card">
            ...
            <div className="card-body">
                { /*begin::Title*/ }
                <h2 className="text-dark load-txt">ใบอนุญาตจัดหางานให้คนจัดหางานทำงานในต่างประเทศ</h2>
                <span>คำขอ<span className="load-txt">ใบอนุญาตจัดหางานให้คนจัดหางานทำงานในต่างประเทศ</span></span>
            </div>
        </div>
        <div className="card">
            <div className="card-body form-steps ">
                <form action="#">
                    <div className="step-arrow-nav mb-4 pt-3">
                        ...
                        <ul className="nav nav-pills custom-nav nav-justified" role="tablist">
                            <li className="nav-item" role="presentation">
                                <button className="nav-link active" id="datainfo1-tab" data-bs-toggle="pill" data-bs-target="#datainfo1" type="button" role="tab" aria-controls="datainfo1" aria-selected="false" data-position="0" tabIndex={-1}><b>1. ข้อมูลบริษัท</b></button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link " id="datainfo2-tab" data-bs-toggle="pill" data-bs-target="#datainfo2" type="button" role="tab" aria-controls="datainfo2" aria-selected="true" data-position="1"><b>2. รายชื่อกรรมการ</b></button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="datainfo3-tab" data-bs-toggle="pill" data-bs-target="#datainfo3" type="button" role="tab" aria-controls="datainfo3" aria-selected="false" data-position="2"><b>3. รายชื่อผู้ถือหุ้น</b></button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="datainfo4-tab" data-bs-toggle="pill" data-bs-target="#datainfo4" type="button" role="tab" aria-controls="datainfo4" aria-selected="false" data-position="3"><b>4. เลือกผู้จัดการ</b></button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="datainfo5-tab" data-bs-toggle="pill" data-bs-target="#datainfo5" type="button" role="tab" aria-controls="datainfo5" aria-selected="false" data-position="4"><b>5. เอกสารประกอบ</b></button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="datainfo6-tab" data-bs-toggle="pill" data-bs-target="#datainfo6" type="button" role="tab" aria-controls="datainfo6" aria-selected="false" data-position="5"><b>6. หลักประกัน</b></button>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="tab-content">
                        ...
                        { /* tab-1 */ }
                        <div className="tab-pane fade show active" id="datainfo1" role="tabpanel" aria-labelledby="datainfo1-tab">
                            <div>
                                <div className="mb-4">
                                    <div>
                                        <h5 className="mb-1"><b>ข้อมูลบริษัท</b></h5>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="steparrow-gen-info-email-input">เลขที่บุคคละรรมดา/นิติบุคคล</label>
                                            <input type="text" className="form-control" placeholder="" />
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="steparrow-gen-info-username-input">ประเภทนิติบุคคล</label>
                                            <input type="text" className="form-control" placeholder="" />
                                        </div>
                                    </div>
                                    <div className="col-lg-4">
                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="steparrow-gen-info-username-input">วันที่จดทะเบียน</label>
                                    ...
                                    <div className="col-lg-8">
                                        <div className="mb-3">
                                            <label className="form-label" htmlFor="steparrow-gen-info-username-input">ทุนจดทะเบียน</label>
                                            <input type="text" className="form-control" placeholder="" />
                                        ...
                                        <div className="row g-2" style={{ minHeight: "9rem" }}>
                                            <div className="col-lg-4">
                                                <div className="col-lg-12">
                                                    <div className="mb-3">
                                                        <label className="form-label" htmlFor="steparrow-gen-info-username-input">ละติจูด</label>
                                                        <input type="text" className="form-control" placeholder="" />
                                                    </div>
                                                </div>
                                                <div className="col-lg-12">
                                                    <div className="mb-3">
                                                        <label className="form-label" htmlFor="steparrow-gen-info-username-input">ลองจิจูด</label>
                                                        <input type="text" className="form-control" placeholder="" />
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="mb-4 mt-5">
                                    <div>
                                        <h5 className="mb-1"><b>แนบรูปที่ตั้งสำนักงาน</b></h5>
                            ...
                            <div className="d-flex align-items-start gap-3 mt-4">
                                <button type="button" className="btn btn-primary btn-label right ms-auto nexttab nexttab" data-nexttab="datainfo2-tab"><i className="ri-arrow-right-line label-icon align-middle fs-16 ms-2" />NEXT</button>
                            </div>
                        </div>
                        { /* end tab pane */ }
                        ...
                        <div className="tab-pane fade " id="datainfo2" role="tabpanel" aria-labelledby="datainfo2-tab">
                            <div className="row">
                                <div className="col-8 mb-4 mt-3">
                                    <div>
                                        <h5 className="mb-1"><b>รายชื่อกรรมการทั้งหมด</b></h5>
                                    </div>
                                </div>
                                <div className="col-4" style={{ textAlign: "right" }}>
                                    ...
                                    <button type="button" className="btn btn-soft-success" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                        ...
                                        <table className="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" className="btn btn-sm btn-light">เปลี่ยนแปลงข้อมูล</button>
                            ...
                            <div className="d-flex align-items-start gap-3 mt-4">
                                <button type="button" className="btn btn-light btn-label previestab" data-previous="datainfo1-tab"><i className="ri-arrow-left-line label-icon align-middle fs-16 me-2" /> BACK</button>
                                <button type="button" className="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="datainfo3-tab"><i className="ri-arrow-right-line label-icon align-middle fs-16 ms-2" />NEXT</button>
                            </div>
                        </div>
                        { /* end tab pane */ }
                        ...
                        <div className="tab-pane fade" id="datainfo3" role="tabpanel" aria-labelledby="#datainfo3-tab">
                            <div className="row">
                                <div className="col-8 mb-4 mt-3">
                                    <div>
                                        <h5 className="mb-1"><b>รายชื่อผู้ถือหุ้นทั้งหมด</b></h5>
                                    </div>
                                </div>
                                <div className="col-4" style={{ textAlign: "right" }}>
                                    <button type="button" className="btn btn-soft-primary">
                            ...
                            <div className="d-flex align-items-start gap-3 mt-4">
                                <button type="button" className="btn btn-light btn-label previestab" data-previous="datainfo2-tab"><i className="ri-arrow-left-line label-icon align-middle fs-16 me-2" /> BACK</button>
                                <button type="button" className="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="datainfo4-tab"><i className="ri-arrow-right-line label-icon align-middle fs-16 ms-2" />NEXT</button>
                            </div>
                        </div>
                        ...
                        <div className="tab-pane fade" id="datainfo4" role="tabpanel" aria-labelledby="#datainfo4-tab">
                            <div className="row">
                                <div className="col-12 mb-4 mt-3">
                                    <div>
                                        <h5 className="mb-1"><b>เลือกผู้จัดการ</b></h5>
                                    </div>
                                </div>
                                <div className="col-12">
                                    <div className="table-responsive">
                                        <table className="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" className="btn btn-sm btn-light">ดูรายละเอียด</button>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">
                            ...
                            <div className="d-flex align-items-start gap-3 mt-4">
                                <button type="button" className="btn btn-light btn-label previestab" data-previous="datainfo3-tab"><i className="ri-arrow-left-line label-icon align-middle fs-16 me-2" /> BACK</button>
                                <button type="button" className="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="datainfo5-tab"><i className="ri-arrow-right-line label-icon align-middle fs-16 ms-2" />NEXT</button>
                            </div>
                        </div>
                        ...
                        <div className="tab-pane fade" id="datainfo5" role="tabpanel" aria-labelledby="#datainfo5-tab">
                            <div className="row">
                                <div className="col-12 mb-4 mt-3">
                                    <div>
                                        <h5 className="mb-1"><b>เอกสารประกอบ</b></h5>
                                    </div>
                                </div>
                                <div className="col-12">
                            ...
                            <div className="d-flex align-items-start gap-3 mt-4">
                                <button type="button" className="btn btn-light btn-label previestab" data-previous="datainfo4-tab"><i className="ri-arrow-left-line label-icon align-middle fs-16 me-2" /> BACK</button>
                                <button type="button" className="btn btn-success btn-label right ms-auto nexttab nexttab" data-nexttab="datainfo6-tab"><i className="ri-arrow-right-line label-icon align-middle fs-16 ms-2" />NEXT</button>
                            </div>
                        </div>
                        ...
                        <div className="tab-pane fade" id="datainfo6" role="tabpanel" aria-labelledby="#datainfo6-tab">
                            <div className="row">
                                <div className="col-8 mb-4 mt-3">
                                    <div>
                                        <h5 className="mb-1"><b>รายการหลักประกัน</b></h5>
                                    </div>
                                </div>
                                    ...
                                    <div className="form-group">
                                        <table className="table align-middle table-nowrap mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>-</td>
                                                    <td>
                                                        <button type="button" className="btn btn-sm btn-light"><i className="ri-eye-line" /> ดูรายละเอียด</button>
                                                        <button type="button" className="btn btn-sm btn-danger"><i className="ri-delete-bin-line" /> ลบ</button>
                                                    </td>
                                                </tr>
                                        ...
                                        <div className="row mb-5 mt-5">
                                            <div className="col-12 text-center">
                                                <button type="button" className="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal"><i className="ri-add-line" /> เพิ่มรายการ</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="col-8 mb-4">
                                    <div>
                                        <h5 className="mb-1"><b>รวมเป็นเงิน</b></h5>
                                    </div>
                                </div>
                                <div className="col-12">
                                    <div className="row mb-5">
                                        <div className="col-4">
                                            <input type="text" className="form-control" placeholder="" value="5,000,000,000 (\u0E2B\u0E49\u0E32\u0E25\u0E49\u0E32\u0E19\u0E1A\u0E32\u0E17\u0E16\u0E49\u0E27\u0E19)" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="d-flex align-items-start gap-3 mt-4">
                                <button type="button" className="btn btn-light btn-label previestab" data-previous="datainfo4-tab"><i className="ri-arrow-left-line label-icon align-middle fs-16 me-2" /> BACK</button>
                                <button type="button" className="btn btn-success btn-label right ms-auto"><i className="ri-save-line" /> บันทึกข้อมูล</button>
                            </div>
                        </div>
                        { /* end tab pane */ }
                    </div>
