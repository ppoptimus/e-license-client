          ...
          <div className="col-xl-12">
            <div className="card">
              ...
              <div className="card-body">
                {/*begin::Title*/}
                <h2 className="text-dark load-txt">ใบอนุญาตจัดหางานให้คนจัดหางานทำงานในประเทศ</h2>
                <span>
                  คำขอ<span className="load-txt">ใบอนุญาตจัดหางานให้คนจัดหางานทำงานในประเทศ</span>
                </span>
              </div>
            </div>
            <div className="card">
