                                    ...
                                    <div className="col-xl-8">
                                        <div className="card">
                                            ...
                                            <div className="card-body p-0 pb-2">
                                                <div className="w-100">
                                                    <div id="customer_impression_charts" data-colors='["--vz-primary", "--vz-success", "--vz-danger"]' className="apex-charts" dir="ltr" />
                                                </div>
                                            </div>{ /* end card body */ }
                                        </div>{ /* end card */ }
                                    </div>{ /* end col */ }
                                    ...
                                    <div className="col-xl-4">
                                        ...
                                        <div className="card card-height-100">
                                            ...
                                            <div className="card-body">
                                                ...
                                                <div id="sales-by-locations" data-colors='["--vz-light", "--vz-success", "--vz-primary"]' style={{ height: 269 }} dir="ltr" />
                                                ...
                                                <div className="px-2 py-2 mt-1">
                                                    ...
                                                    <div className="progress mt-2" style={{ height: 6 }}>
                                                        <div className="progress-bar progress-bar-striped bg-primary" role="progressbar" style={{ width: "47%" }} aria-valuenow="47" aria-valuemin="0" aria-valuemax="47" />
                                                    </div>

                                                    <p className="mt-3 mb-1">Russia <span className="float-end">82%</span></p>
                                                    <div className="progress mt-2" style={{ height: 6 }}>
                                                        <div className="progress-bar progress-bar-striped bg-primary" role="progressbar" style={{ width: "82%" }} aria-valuenow="82" aria-valuemin="0" aria-valuemax="82" />
                                                    </div>
                                                </div>
                                            </div>
                                            { /* end card body */ }
                                                    ...
                                                    <table className="table table-centered table-hover align-middle table-nowrap mb-0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <h5 className="fs-14 mb-0">32%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" /></h5>
                                                                </td>
                                                            </tr>{ /* end */ }
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <h5 className="fs-14 mb-0">79%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" /></h5>
                                                                </td>
                                                            </tr>{ /* end */ }
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <h5 className="fs-14 mb-0">90%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" /></h5>
                                                                </td>
                                                            </tr>{ /* end */ }
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <h5 className="fs-14 mb-0">40%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" /></h5>
                                                                </td>
                                                            </tr>{ /* end */ }
                                                            <tr>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <h5 className="fs-14 mb-0">57%<i className="ri-bar-chart-fill text-success fs-16 align-middle ms-2" /></h5>
                                                                </td>
                                                            </tr>{ /* end */ }
                                                        </tbody>
                                                    </table>{ /* end table */ }
                                ...
                                <div className="row">
                                    <div className="col-xl-4">
                                        <div className="card card-height-100">
                                            ...
                                            <div className="card-body">
                                                <div id="store-visits-source" data-colors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-danger", "--vz-info"]' className="apex-charts" dir="ltr" />
                                            </div>
                                        </div> { /* .card*/ }
                                    </div> { /* .col*/ }
                                        ...
                                        <div className="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                                            <div className="card-body">
                                                ...
                                                <div className="mt-4">
                                                    ...
                                                    <button type="button" className="btn btn-primary btn-label rounded-pill"><i className="ri-mail-fill label-icon align-middle rounded-pill fs-16 me-2" /> Invite Now</button>
                                                </div>
                                            </div>
                                        </div>
